...
document.addEventListener("DOMContentLoaded", () => {
    ...
    for(let hero of superheroes) {                          // проходим циклом по массиву и добавляем в html
        ...
        <div class="hero_card">
            ...
            <p class="hero_universe">Вселенная: ${hero.universe}</p>
            <p class="hero_alterego">Альтерэго: ${hero.alterego}</p>
            <p class="hero_occupation">Род деятельности: ${hero.occupation}</p>
            <p class="hero_friends">Друзья: ${hero.friends}</p>
            <p class="hero_power">Суперсилы: ${hero.superpowers}</p>
